<input type="hidden" :name="nameAttr" :value="value" :required="required && !value">
...
<button
    ...
    :disabled="disabled"
    class="flex w-full min-h-[2.75rem] items-center justify-between gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-left text-sm shadow-sm hover:border-amber-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 disabled:cursor-not-allowed disabled:bg-slate-50"
...
<template x-teleport="body">
    <div
        ...
        class="flex flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl"
    ...
    >
        ...
        <ul class="min-h-[10rem] flex-1 overflow-y-auto py-1 text-sm">
